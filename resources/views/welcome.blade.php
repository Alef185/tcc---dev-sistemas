...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <style>
        .gradient {
        background: linear-gradient(90deg, #352b52 0%, #da519c 100%);}
    ...
    <body class="leading-normal tracking-normal text-white gradient" style="font-family: 'Source Sans Pro', sans-serif;">
        ...
        <nav id="header" class="fixed w-full z-30 top-0 text-white">
          <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
            ...
            <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto mt-2 lg:mt-0 lg:bg-transparent text-black p-4 lg:p-0 z-20" id="nav-content"">
                @if (Route::has('login'))
        ...
        <div class="pt-24">
          <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
            ...
            <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
              <p class="uppercase tracking-loose w-full">O que é a ferramenta?</p>
              <h1 class="my-4 text-5xl font-bold leading-tight">
                EzOffice é seu guia no trabalho à distância
              </h1>
              <p class="leading-normal text-2xl mb-8">
                Fácil, prático, e sem complicações, objetivo como você!
              </p>
            ...
            <div class="flex flex-wrap">
              <div class="w-5/6 sm:w-1/2 p-6">
                ...
                <p class="text-gray-600 mb-8">
                  Nosso sistema possui um uma ferramenta que te auxilia na hora de organizar suas tarefas pendentes e trabalhos.
                  <br />
                  <br />
                </p>
              </div>
            ...
            <div class="flex flex-wrap flex-col-reverse sm:flex-row">
              ...
              <div class="w-full sm:w-1/2 p-6 mt-6">
                <div class="align-middle">
                  ...
                  <p class="text-gray-600 mb-8">
                    Através da plataforma EzOFfice você pode gerrenciar sua equipe, cria novas equipes, gerir seus membros, adicionar novas tarefas, e muito mais!
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="flex flex-col sm:flex-row justify-center pt-12 my-12 sm:my-4">
              <div class="flex flex-col w-5/6 lg:w-1/4 mx-auto lg:mx-0 rounded-none lg:rounded-l-lg bg-white mt-4">
                <div class="flex-1 bg-white text-gray-600 rounded-t rounded-b-none overflow-hidden shadow">
                  ...
                  <ul class="w-full text-center text-sm">
                    <li class="border-b py-4">Task Manager</li>
                    <li class="border-b py-4">Team (max. 3)</li>
                    <li class="border-b py-4">Manager</li>
                  </ul>
                </div>
                <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
                  <div class="w-full pt-6 text-3xl text-gray-600 font-bold text-center">
                    R$0
                    <span class="text-base">vitalício</span>
                  </div>
                  <div class="flex items-center justify-center">
                    <button class="mx-auto lg:mx-0 hover:underline gradient text-white font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
                      Contratar
              ...
              <div class="flex flex-col w-5/6 lg:w-1/3 mx-auto lg:mx-0 rounded-lg bg-white mt-4 sm:-mt-6 shadow-lg z-10">
                <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
                  ...
                  <ul class="w-full text-center text-base font-bold">
                    <li class="border-b py-4">Task Manager</li>
                    <li class="border-b py-4">Team Manager</li>
                    <li class="border-b py-4">Employee Manager</li>
                    <li class="border-b py-4">Cronograma</li>
                  </ul>
                </div>
                <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
                  <div class="w-full pt-6 text-4xl font-bold text-center">
                    R$39,99
                    <span class="text-base">/ mês</span>
                  </div>
                  <div class="flex items-center justify-center">
                    <button class="mx-auto lg:mx-0 hover:underline gradient text-white font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
                      Contratar
              ...
              <div class="flex flex-col w-5/6 lg:w-1/4 mx-auto lg:mx-0 rounded-none lg:rounded-l-lg bg-white mt-4">
                <div class="flex-1 bg-white text-gray-600 rounded-t rounded-b-none overflow-hidden shadow">
                  ...
                  <ul class="w-full text-center text-sm">
                    <li class="border-b py-4">Task Manager</li>
                    <li class="border-b py-4">Multi Team Manager</li>
                    <li class="border-b py-4">Employee Manager Advanced</li>
                    <li class="border-b py-4">Cronograma e Gerenciamento</li>
                  </ul>
                </div>
                <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
                  <div class="w-full pt-6 text-3xl text-gray-600 font-bold text-center">
        ...
        <section class="container mx-auto text-center py-6 mb-12">
          ...
          <h3 class="my-4 text-3xl leading-tight">
            Caso tenha alguma dúvida ou queira contratar planos especiais
          </h3>
          <button class="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
            Contatar
          </button>
